...
echo Convert
	echo/
	ffmpeg -loglevel error -v error -stats -i "%file%" -vf scale=3840x2160:flags=lanczos,format=yuv420p10le -crf 24 -preset faster -tune fastdecode -an -sn "%name%-2160p.x264.10b.Sdr-NoSound.mkv"
	echo/
