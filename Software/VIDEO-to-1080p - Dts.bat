...
echo Convert
	echo/
	ffmpeg -loglevel error -v error -stats -i "%file%" -vf scale=1920x1080:flags=lanczos,format=yuv420p10le -crf 24 -preset faster -tune fastdecode -strict experimental -c:a dts "%name%-1080p.x264.10b.Sdr-Dts.mkv"
	echo/
