...
echo -------------------------=========== SEPARATOR =============-------------------------
echo Lead-in
	echo LostByteSoft Version 2025-08-30-14-06-14
...
echo Convert
	echo/
	ffmpeg -loglevel error -v error -stats -i "%file%" -vf scale=1920x1080:flags=lanczos,format=yuv420p -crf 24 -preset faster -tune fastdecode -strict experimental -c:a dts "%name%-1080p.x264.10b.Sdr-Dts.mkv"
	echo/
